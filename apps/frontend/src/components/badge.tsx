...
type BadgeButtonAsButtonProps = {
  className?: string
  children: React.ReactNode
  href?: never
} & Omit<React.ComponentPropsWithoutRef<'button'>, 'className'>

type BadgeButtonAsLinkProps = {
  className?: string
  children: React.ReactNode
  href: string
} & Omit<React.ComponentPropsWithoutRef<'a'>, 'className' | 'href'>

type BaseBadgeButtonProps = BadgeButtonAsButtonProps | BadgeButtonAsLinkProps
...
export const BadgeButton = forwardRef<HTMLElement, BadgeButtonProps>(function BadgeButton(
  ...
  return 'href' in props ? (
    <Link
      {...(props as BadgeButtonAsLinkProps)}
      className={classes}
    ...
    <Headless.Button
      {...(props as BadgeButtonAsButtonProps)}
      className={classes}
