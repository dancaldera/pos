...
export const NavbarItem = forwardRef<HTMLElement, NavbarItemProps>(function NavbarItem(
  ...
  return (
    <span className={clsx(className, 'relative')}>
      ...
      {'href' in props ? (
        <Link
          {...(props as Omit<React.ComponentPropsWithoutRef<'a'>, 'className'> & { href: string })}
          className={classes}
