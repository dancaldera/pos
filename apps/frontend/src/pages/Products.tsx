    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="w-full md:w-64">
          <Select value={searchParams.categoryId} onChange={handleCategoryFilter}>
            <option value="">
                ...
                products.map((product) => (
                  <TableRow key={product.id}>
                    ...
                    <TableCell>
                      ...
                      {product.sku && (
                        <Text className="text-xs text-gray-500">SKU: {product.sku}</Text>
                      )}
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <Text className="text-sm text-gray-900">{formatCurrency(product.price)}</Text>
                      {product.cost && (
                    ...
                    <TableCell>
                      {product.hasVariants && product.variants && product.variants.length > 0 ? (
                        ...
                        <Text>
                          {translate.common('no')} {translate.products('variants')}
                        </Text>
                      )}
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <div className="flex space-x-2 justify-end">
                        <Button outline onClick={() => openEditModal(product)}>
                          <PencilIcon className="h-5 w-5" />
                        </Button>
                        <Button color="red" onClick={() => openDeleteModal(product)}>
            ...
            <div className="flex justify-between items-center mt-6">
              <div className="text-sm text-gray-500">
                {pagination.total > 0
                  ...
                  : '0'}{' '}
                {translate.products('title').toLowerCase()}
              </div>
      ...
      <Dialog open={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <DialogTitle>
          {currentProduct ? translate.products('editProduct') : translate.products('addProduct')}
        </DialogTitle>
        <DialogBody>
            ...
            <Fieldset className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-4">
                  {/* Name */}
                  <Field>
                    <Label>{translate.products('productName')} *</Label>
                    <Input
                      type="text"
                      name="name"
                      value={formData.name}
                  ...
                  {/* Description */}
                  <Field>
                    <Label>{translate.products('productDescription')}</Label>
                    <Textarea
                      name="description"
                  ...
                  {/* Category */}
                  <Field>
                    <Label>{translate.products('productCategory')}</Label>
                    <Select
                      name="categoryId"
                    ...
                    >
                      <option value="">
                        {translate.common('select')} {translate.categories('title').toLowerCase()}
                      </option>
                      {categories.map((category) => (
                        <option key={category.id} value={category.id}>
                          {category.name}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <Field>
                      <Label>{translate.products('productPrice')} *</Label>
                      <Input
                        type="number"
                        name="price"
                      ...
                      />
                      {formErrors.price && (
                        <Text className="mt-1 text-sm text-red-600">{formErrors.price}</Text>
                      )}
                    </Field>
                    <Field>
                      <Label>{translate.products('productCost')}</Label>
                      <Input
                        type="number"
                        name="cost"
                        value={formData.cost || ''}
                ...
                <div className="space-y-4">
                  {/* Image Upload */}
                  <Field>
                    <Label>{translate.products('productImage')}</Label>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <Field>
                      <Label>{translate.products('productSKU')}</Label>
                      <Input
                        type="text"
                        name="sku"
                        value={formData.sku || ''}
                    ...
                    <Field>
                      <Label>{translate.products('productBarcode')}</Label>
                      <Input
                        type="text"
                        name="barcode"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <Field>
                      <Label>{translate.products('stockQuantity')}</Label>
                      <Input
                        type="number"
                        name="stock"
                      ...
                      />
                      {formErrors.stock && (
                        <Text className="mt-1 text-sm text-red-600">{formErrors.stock}</Text>
                      )}
                    </Field>
                    <Field>
                      <Label>{translate.products('lowStockAlert')}</Label>
                      <Input
                        type="number"
                        name="lowStockAlert"
                  ...
                  <Field>
                    ...
                    />
                    <Label htmlFor="active">{translate.products('activeForSale')}</Label>
                  </Field>
                  ...
                  <Field>
                    <div className="flex items-center mb-2">
                      ...
                      />
                      <Label htmlFor="hasVariants">{translate.products('hasVariants')}</Label>
                    </div>
                    ...
                    {formData.hasVariants && (
                      ...
                      >
                        <Label className="block mb-2">{translate.products('variants')}</Label>
                        {formErrors.variants && (
                          <Text className="text-sm text-red-600 mb-2">{formErrors.variants}</Text>
                        )}
