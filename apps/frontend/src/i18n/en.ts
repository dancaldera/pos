...
const en = {
  ...
  auth: {
    ...
    resetEmailSentSuccess: 'Password reset instructions have been sent to your email',
    resetEmailSentFailed: 'Failed to send reset email',
  ...
  orders: {
    ...
    quickDaySelection: 'Quick Day Selection',
