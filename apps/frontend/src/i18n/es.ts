...
const es = {
  ...
  auth: {
    ...
    emailSentMessage: 'Hemos enviado las instrucciones para restablecer su contraseña a',
    emailNotReceived: '¿No recibió el correo? Revise su carpeta de spam o intente nuevamente.',
    tryDifferentEmail: 'Probar con Otro Correo',
    resetPasswordTitle: 'Restablecer su Contraseña',
    resetPasswordDescription: 'Ingrese su nueva contraseña a continuación.',
  ...
  orders: {
    ...
    discountUpdateFailed: 'Error al actualizar el descuento. Por favor, inténtelo de nuevo.',
    discountNote: 'Este descuento se aplicará al subtotal del pedido.',
    ...
    quickDaySelection: 'Selección rápida de día',
